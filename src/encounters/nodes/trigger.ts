...
// connection resolves to a ResolvedMoment (src/encounters/runtime.ts,
// src/encounters/evaluate.ts).
//
// Just ENCOUNTER_START / ENCOUNTER_END here -- see cast-trigger.ts for the
// SPELL_CAST_START / SPELL_CAST_SUCCESS pair. The rest of the trigger
// vocabulary (auraApplied, timer, ...) gets its own node as phases with
// real mechanics need them.
